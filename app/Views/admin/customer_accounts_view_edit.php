...
<div class="page-header">
    ...
    <ul class="breadcrumbs">
        ...
        <li class="nav-item">
            <a style="color: white;" href="<?= base_url('eshop-admin/customer-accounts'); ?>">Daftar Akun Pembeli</a>
        </li>
        <li class="separator">
            <i class="flaticon-right-arrow text-white"></i>
        </li>
        <li class="nav-item">
            <a style="color: white;" href="#">Ubah Akun Pembeli</a>
        </li>
    </ul>
</div>
        ...
        <div class="card-body card">
            ...
            <div class="tab-content mt-4" id="nav-tabContent">
                ...
                <div class="<?= $class_siswa_tab ?>" id="nav-profile" role="tabpanel">
                    <form action="<?= base_url('eshop-admin/customer-accounts/update') ?>" method="post">
                ...
                <div class="<?= $class_kelompok_kelas_tab ?>" id="nav-password" role="tabpanel">
                    <form action="<?= base_url('eshop-admin/customer-accounts/reset-password') ?>" method="post">
                        <input type="hidden" name="id" value="<?= $dataAccount->id; ?>">
